...
console.log(obj); // { prop_1: 1, prop_2: 2, prop: 3 }
```
...
## 4. **_proto_** 프로퍼티에 의한 상속

ES5에서 객체 리터럴을 상속하기 위해서는 Object.create() 함수를 사용한다. 이를 프로포토타입 패턴 상속이라 한다.
...
ES6에서는 객체 리터럴 내부에서 **_proto_** 프로퍼티를 직접 설정할 수 있다. 이것은 객체 리터럴에 의해 생성된 객체의 **_proto_** 프로퍼티에 다른 객체를 직접 바인딩하여 상속을 표현할 수 있음을 의미한다.
